...
def Q4a():
    ...
    wall1 =  Wall({'position': [0, 0, 0], 'width':3, 'height':2.6, 'edges': True, 'orientation': 90})
    wall2 =  Wall({'position': [3, 0, 0], 'width':7, 'height':2.6, 'edges': True})
    wall3 =  Wall({'position': [0, 3, 0], 'width':3, 'height':2.6, 'edges': True, 'orientation': -90})
    wall4 =  Wall({'position': [7, 3, 0], 'width':7, 'height':2.6, 'edges': True})
